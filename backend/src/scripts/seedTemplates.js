  ...
  },
  {
    ...
    html_content: `
      <div class="resume-container-classic">
        ...
        {{#if projects.length}}<section class="sec"><h2>Projects</h2>{{#each projects}}<div class="item"><h3>{{name}}</h3>{{#if link}}<div style="font-size:9.5pt; font-style:italic;"><a href="{{link}}" style="color:#000;">{{link}}</a></div>{{/if}}<p>{{nl2br description}}</p></div>{{/each}}</section>{{/if}}
    ...
    html_content: `
      <div class="resume-dark">
        ...
        <div style="padding:0;">
          ...
          {{#if projects.length}}<section><h2>Projects</h2>{{#each projects}}<div class="item"><h3>{{name}}</h3>{{#if link}}<a href="{{link}}" style="color:var(--primary); font-size:9pt; font-weight:500;">{{link}}</a>{{/if}}<p>{{nl2br description}}</p></div>{{/each}}</section>{{/if}}
  ...
  },
  {
    ...
    html_content: `
      <div style="line-height:1.3;">
        ...
        {{#if projects.length}}<section style="margin-bottom:20px;"><h2 style="font-size:12pt; border-bottom:1px solid #000; margin-bottom:8px;">PROJECTS</h2>{{#each projects}}<div style="margin-bottom:12px;"><div style="display:flex; justify-content:space-between;"><strong>{{name}}</strong></div>{{#if link}}<div style="font-size:9.5pt;"><a href="{{link}}" style="color:#000;">{{link}}</a></div>{{/if}}<p style="font-size:10pt; margin-top:4px;">{{nl2br description}}</p></div>{{/each}}</section>{{/if}}
